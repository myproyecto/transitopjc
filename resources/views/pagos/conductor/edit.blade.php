    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h3>Editar Conductor: {{ $persona->nombre}}</h3>
                @if (count($errors)>0)
            ...
            {!!Form::model($persona,['method'=>'PATCH','route'=>['conductor.update',$persona->idpersona]])!!}
            {{Form::token()}}
<div class="panel panel-primary">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="num_doc" value="{{$persona->num_documento}}" class="form-control">             
                </div>
            </div>
        </div>
